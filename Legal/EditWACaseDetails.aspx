                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <fieldset id="Fieldset_HearingDtl" runat="server">
                            ...
                            <div class="row">--%>
                                ...
                                <div class="col-md-3" id="HearingDtl_CaseDispose" runat="server" visible="false" style="padding-top: 3%;">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <asp:Button ID="btnCaseDispose" runat="server" CssClass="btn btn-primary" Text="Case Dispose" OnClick="btnCaseDispose_Click" ValidationGroup="CaseDispose" />
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <asp:GridView ID="GrdCaseDispose" runat="server" BorderWidth="2px" CssClass="table text-center" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText=" Order No." DataField="CaseDispose_OrderNo" />
                                            <asp:BoundField HeaderText="Case Dispose Date" DataField="CaseDisposeDate" />
                                            <asp:TemplateField HeaderText="Order Document">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="HyperlinkOrderDoc" runat="server" Target="_blank" NavigateUrl='<%# "WACaseDispose/" + Eval("CaseDispose_OrderDoc") %>' CssClass="btn-sm label label-primary">View</asp:HyperLink>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                        ...
                        <fieldset id="Case_EditField" runat="server" visible="false">
                            <legend>Edit WA Case Details</legend>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Case No.</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Nodal Officer Email-ID</label><span style="color: red;"><b>*</b></span>                                       
                                        <asp:TextBox ID="txtNodalOfficerEmail" runat="server" onkeypress="return NumberOnly();" AutoComplete="off" MaxLength="10" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        <label>OIC Email-ID</label><span style="color: red;"><b>*</b></span>                                       
                                        <asp:TextBox ID="txtOICEmailID" runat="server" onkeypress="return NumberOnly();" AutoComplete="off" MaxLength="10" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtNodalEmailID" runat="server" onkeypress="return NumberOnly();" AutoComplete="off" MaxLength="10" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Case Subject</label><span style="color: red;"><b>*</b></span>
                                         <asp:DropDownList ID="ddlCaseSubject" runat="server" CssClass="form-control">
                                            ...
                                            <asp:ListItem>प्रत्नियूक्ति</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
