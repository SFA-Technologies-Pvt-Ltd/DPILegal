                            ...
                            <div class="col-md-12">
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Policymeter</label>
                                                <%--<span style="color: red;"><b>*</b></span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator16" ValidationGroup="CaseDtl"
                                                    ErrorMessage="Select Policymeter Status." ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Required !'></i>"
                                                    ControlToValidate="ddlPolicyMeter" Display="Dynamic" runat="server" InitialValue="0">
                                                </asp:RequiredFieldValidator>--%>
                                ...
                                <fieldset>
                                    ...
                                    <div id="Div_IntrimOrderYesNO" runat="server" visible="false">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Any PP</label><span style="color: red;"><b>*</b></span>
