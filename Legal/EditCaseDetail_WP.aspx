<%@ Page Title="" Language="C#" MasterPageFile="~/Legal/MainMaster.master" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" AutoEventWireup="true" CodeFile="EditCaseDetail_WP.aspx.cs" Inherits="Legal_EditCaseDetail_WP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <asp:ValidationSummary ID="ValidationSummary11" runat="server" ValidationGroup="First" ShowMessageBox="true" ShowSummary="false" />
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <asp:RegularExpressionValidator ID="rfvPetiadvocatemobile" ValidationGroup="Petitioner" runat="server" Display="Dynamic" ControlToValidate="txtPetiMobileNo"
                                                    ...
                                                    ForeColor="Red" ValidationExpression="^([6-9]{1}[0-9]{9})$">
                                                </asp:RegularExpressionValidator>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class="table-responsive">
                                                <asp:GridView ID="GrdPetiAdv" runat="server" CssClass="table table-bordered " AutoGenerateColumns="false" EmptyDataText="NO RECORD FOUND" DataKeyNames="PetiAdv_Id" OnRowCommand="GrdPetiAdv_RowCommand">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("PetiAdv_Id") %>' CommandName="EditRecord" ToolTip="Edit" CssClass="fa fa-edit"></asp:LinkButton>
                                                                &nbsp;
                                                                <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# Eval("PetiAdv_Id") %>' CommandName="DeleteRecord" ToolTip="Delete" OnClientClick="return confirm('Are you sure you want to delete this record?');" CssClass="fa fa-trash"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Sr#" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="Label2" runat="server" Text='<%# Eval("Case_ID") %>' Visible="false"></asp:Label>
                                                                <asp:Label ID="Label3" runat="server" Text='<%# Eval("UniqueNo") %>' Visible="false"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Designation ">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="Label4" runat="server" Text='<%# Eval("Designation_Id") %>' Visible="false"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%# Eval("Respondent_ID") %>' CommandName="EditRecord" ToolTip="Edit" CssClass="fa fa-edit"></asp:LinkButton>

                                                                <asp:LinkButton ID="LinkButton4" runat="server" CommandArgument='<%# Eval("Respondent_ID") %>' CommandName="DeleteRecord" ToolTip="Delete" CssClass="fa fa-trash" OnClientClick="return confirm('Are you sure you want to delete this record?');"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Sr#" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="Label7" runat="server" Text='<%# Eval("Case_ID") %>' Visible="false"></asp:Label>
                                                                <asp:Label ID="Label8" runat="server" Text='<%# Eval("UniqueNo") %>' Visible="false"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Advocate Name">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton5" runat="server" CommandArgument='<%# Eval("DeptAdv_Id") %>' CommandName="EditRecord" ToolTip="Edit" CssClass="fa fa-edit"></asp:LinkButton>
                                                                &nbsp;
                                                                <asp:LinkButton ID="LinkButton6" runat="server" CommandArgument='<%# Eval("DeptAdv_Id") %>' CommandName="DeleteRecord" ToolTip="Delete" OnClientClick="return confirm('Are you sure you want to delete this record?');" CssClass="fa fa-trash"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                ...
                                <fieldset>
                                    <legend>Case Disposal at First Hearing</legend>
                                    <div class="row">
                                       <%-- <div class="col-md-3">
                                            <p style="font: bold">Click here to Dismiss the case</p>
                                        </div>--%>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" ValidationGroup="Fr"
                                                    ErrorMessage="Enter Case Dispose Date." ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Required !'></i>"
                                                    ControlToValidate="txtFisrtDisDate" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                                <asp:TextBox ID="txtFisrtDisDate" runat="server" data-provide="datepicker" CssClass="form-control" AutoComplete="off" data-date-format="dd/mm/yyyy" data-date-autoclose="true" placeholder="DD/MM/YYYY"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Order Summary</label><span style="color: red;"><b>*</b></span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator19" ValidationGroup="Fr"
                                                    ErrorMessage="Enter Order Summary" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Required !'></i>"
                                                    ControlToValidate="txtFirstOrderSumm" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                                <asp:TextBox ID="txtFirstOrderSumm" placeholder="Order Summary" runat="server" AutoComplete="off" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-3 mt-5">
                                            <asp:Button ID="BtnDisposedFirst" runat="server" CssClass="btn btn-primary" ValidationGroup="Fr" OnClientClick="myFunction()"  Text="Case Disposal" OnClick="BtnDisposedFirst_Click" />
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                                            ...
                                            <div class="table-responsive">
                                                <asp:GridView ID="GrdOldOCDetail" runat="server" CssClass="table table-bordered text-center" DataKeyNames="Case_ID" AutoGenerateColumns="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton7" runat="server" CommandArgument='<%# Eval("Case_ID") %>' CommandName="EditRecord" ToolTip="Edit" CssClass="fa fa-edit"></asp:LinkButton>
                                                                &nbsp;
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Sr#" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="Label11" runat="server" Text='<%# Eval("NextHearing_ID") %>' Visible="false"></asp:Label>
                                                                <asp:Label ID="Label12" runat="server" Text='<%# Eval("Case_ID") %>' Visible="false"></asp:Label>
                                                                <asp:Label ID="Label13" runat="server" Text='<%# Eval("UniqueNo") %>' Visible="false"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Hearing Date">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label14" runat="server" Text='<%# Eval("NextHearingDate") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton8" runat="server" CommandArgument='<%# Eval("NextHearing_ID") %>' CommandName="EditRecord" ToolTip="Edit" CssClass="fa fa-edit"></asp:LinkButton>

                                                                <asp:LinkButton ID="LinkButton9" runat="server" CommandArgument='<%# Eval("NextHearing_ID") %>' CommandName="DeleteRecord" ToolTip="Delete" CssClass="fa fa-trash" OnClientClick="return confirm('Are you sure you want to delete this record?');"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Sr#" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="Label16" runat="server" Text='<%# Eval("Case_ID") %>' Visible="false"></asp:Label>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:LinkButton ID="LinkButton10" runat="server" CssClass="fa fa-trash" CommandName="DeleteRecord" CommandArgument='<%# Eval("CaseDoc_ID") %>' ToolTip="Delete" OnClientClick="return confirm('Are you sure you want to delete this record?');"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10" runat="server" id="divActionAppealFrom" visible="false">
                                            <div class="form-group">
                                ...
                                <fieldset id="Fieldset_CaseDispose" runat="server" visible="true">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3" runat="server" id="Div_WPRPFiledOrNot" visible="false">
                                            <div class="form-group">
                                                ...
                                                <span style="color: red;"><b>*</b></span>
                                                <asp:RequiredFieldValidator ID="rfv_WPRP" ValidationGroup="WARP"
                                        ...
                                        <div class="col-md-3" runat="server" id="Div_CaseNo" visible="false">
                                            <div class="form-group">
                                                <label>Case No.</label>
                                                <span style="color: red;"><b>*</b></span>
                                                <asp:RequiredFieldValidator ID="rfvCaseNo" ValidationGroup="WARP"
                                        ...
                                        <div class="col-md-3" runat="server" id="div_CaseYear" visible="false">
                                            <div class="form-group">
                                                <label>Case Year</label>
                                                <span style="color: red;"><b>*</b></span>
                                                <asp:RequiredFieldValidator ID="rfvCaseYear" ValidationGroup="WARP"
                                        ...
                                        <div class="col-md-12" runat="server" id="div_WPRPRemark" visible="false">
                                            <div class="form-group">
                                                ...
                                                <span style="color: red;"><b>*</b></span>
                                                <asp:RequiredFieldValidator ID="rfvWPRPRemark" ValidationGroup="WARP"
                                                    ErrorMessage="Enter Remark." ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Required !'></i>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-3" style="padding-top: 2rem! important;" runat="server" id="Div_WPRPbtn" visible="false">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <asp:Button runat="server" ValidationGroup="WARP" CssClass="btn btn-primary btn-block" ID="btnWARPSave" Text="Save" OnClick="btnWARPSave_Click" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <asp:GridView ID="GrdCaseDispose" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered text-center" AutoGenerateRows="false" EmptyDataText="NO RECORD FOUND">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Sr#" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label17" runat="server" Text='<%# Container.DataItemIndex + 1 %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="Sr#" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="Label19" runat="server" Text='<%# Eval("Case_ID") %>' Visible="false"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="8%">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="LinkButton11" runat="server" CommandArgument='<%# Eval("Id") %>' CommandName="EditRecord" ToolTip="Edit" CssClass="fa fa-edit"></asp:LinkButton>
                                                                    &nbsp;
                                                                 <asp:LinkButton ID="LinkButton12" runat="server" CommandArgument='<%# Eval("Id") %>' CommandName="DeleteRecord" ToolTip="Delete" CssClass="fa fa-trash" OnClientClick="return confirm('Are you sure you want to delete this record?');"></asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    </asp:GridView>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Fotter" runat="Server">
    ...
    <script>
        function myFunction() {
            confirm("Do you want to Disposed the Case at fisrt hearing,                              Are you sure ?");
        }
    </script>
</asp:Content>
