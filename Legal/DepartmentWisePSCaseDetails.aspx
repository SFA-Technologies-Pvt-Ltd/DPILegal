<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/Legal/DepartmentWisePSCaseDetails.aspx.cs" Inherits="Legal_DepartmentWisePSCaseDetails" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-3">
                                    <asp:Button Text="Search" runat="server" ID="btnSearch" OnClick="btnSearch_Click" Autoconplete="Off" CssClass="btn btn-primary" />
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="OIC Name">
                                            ...
                                            <EditItemTemplate>
                                                ...
                                                <asp:DropDownList ID="ddlOICName" runat="server">
                                                </asp:DropDownList>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="HyperLink1" CssClass="fa fa-eye" runat="server"
                                                    NavigateUrl='<%# string.Format("~/Legal/ViewPSCaseDocumentByUniqNo.aspx?Department={0}&CaseType={1}&Id={2}",
                    HttpUtility.UrlEncode(Eval("Department").ToString()), HttpUtility.UrlEncode(Eval("CaseType").ToString()), HttpUtility.UrlEncode(Eval("UniqueNo").ToString())) %>'>
                                                </asp:HyperLink>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <%-- <asp:TemplateField HeaderText="Action">
