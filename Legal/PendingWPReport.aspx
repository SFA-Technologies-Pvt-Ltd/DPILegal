                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="GrdPendingReport" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false" DataKeyNames="Case_ID" OnPageIndexChanging="GrdPendingReport_PageIndexChanging" OnRowCommand="GrdPendingReport_RowCommand">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkbtnView" runat="server" CssClass="btn btn-primary" CommandName="ViewDetail" CommandArgument='<%# Eval("Case_ID") %>' ToolTip="View"><i class="fa fa-eye"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
