                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Respondent Type</label><span class="text-danger">*</span>
                                    <asp:DropDownList runat="server" ID="ddloffice" CssClass="form-control select2" ClientIDMode="static" OnSelectedIndexChanged="ddloffice_SelectedIndexChanged" AutoPostBack="true">
                                        ...
                                        <asp:ListItem Value="1">PP Cases</asp:ListItem>
                                        <asp:ListItem Value="2">DPI Cases</asp:ListItem>
                                        <asp:ListItem Value="3">JD Cases</asp:ListItem>
                                        <asp:ListItem Value="4">DEO Cases</asp:ListItem>
                                        <asp:ListItem Value="5">RSK Cases</asp:ListItem>
                                        <asp:ListItem Value="6">TBC Cases</asp:ListItem>
                                    </asp:DropDownList>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label>
                                                Case Category<br />
                                                प्रकरण का प्रकार<span style="color: red;">*</span></label>
                                            <asp:DropDownList ID="ddlCaseType" runat="server" class="form-control select2">
                                                <asp:ListItem>Select</asp:ListItem>
                                                <asp:ListItem>WP Case</asp:ListItem>
                                                <asp:ListItem>WA Case</asp:ListItem>
                                                <asp:ListItem>RP Case</asp:ListItem>
                                                <asp:ListItem>SLP Case</asp:ListItem>
                                ...
                                <div class="col-md-3" runat="server" visible="false">
                                    <div class="form-group">
                                        <label>
                                            Subject of Case<br />
                                            प्रकरण के विषय<span style="color: red;">*</span></label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>
                                            Date of Filing & Reply<br />
                                            फाइलिंग की तारीख</label>
                                        <div class="input-group date">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"></i>
                                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>
                                            Claim Amount/Pray For Relief<br />
                                            दावा राशि/राहत के लिए प्रार्थना<span style="color: red;">*</span></label>
