<%@ Page Title="" Language="C#" MasterPageFile="~/Legal/MainMaster.master" AutoEventWireup="true" CodeFile="OrderByDirectionCase_ForOldDashb.aspx.cs" Inherits="Legal_OrderByDirectionCase_ForOldDashb" %>
                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: inline;" class="float-left">
                            <span style="color: #e5e5e5">ORDER BY DIRECTION CASE</span>
                        </div>
                    ...
                    <fieldset>
                        <legend>Order By Direction Case list</legend>
                        <div class="row">
                            <div class="col-lg col-md col-sm">
                                <div class="">
                                    <asp:GridView ID="GrdOrderByDirectionCase" runat="server" CssClass="datatable table-responsive" Width="100%"
