                            ...
                            <div class="card-body">
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Division Name Eng<span style="color: red;"><b> *</b></span></label>
                                                ...
                                                <asp:TextBox ID="txtDivisionName" runat="server" CssClass="form-control" MaxLength="80" onkeyup="javascript:capFirst(this);" onkeypress="return lettersOnly();" AutoComplete="off" placeholder="Enter Division Name Eng"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>संभाग का नाम (हिंदी में)<span style="color: red;"><b> *</b></span></label>
                                                <span class="pull-right">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="Save"
                                                        ...
                                                        ControlToValidate="txtDivisionNameHin" ForeColor="Red" Display="Dynamic" runat="server">
                                                    </asp:RequiredFieldValidator>
                                                </span>
                                                <asp:TextBox ID="txtDivisionNameHin" runat="server" CssClass="form-control" MaxLength="80" AutoComplete="off" placeholder="संभाग का नाम (हिंदी में ) दर्ज करे "></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <a href="Mst_Division.aspx" class="btn btn-default btn-block">Clear</a>
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GrddivisionMst" AutoGenerateColumns="false" runat="server" DataKeyNames="Division_ID"
                                                CssClass="datatable table table-bordered table-hover" EmptyDataText="NO RECORD FOUND" OnRowCommand="GrddivisionMst_RowCommand" OnPageIndexChanging="GrddivisionMst_PageIndexChanging">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Division Name(English)">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDivisionName" runat="server" Text='<%# Eval("Division_Name") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="संभाग का नाम (हिंदी में)">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDivision_NameHin" runat="server" Text='<%# Eval("Division_NameHin") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkEditView" runat="server" CommandArgument='<%# Eval("Division_ID") %>' CommandName="EditDetails" ToolTip="Edit"><i class="fa fa-edit"></i></asp:LinkButton>&nbsp;
                                                                <asp:LinkButton ID="lnkbtndelete" runat="server" CommandName="DeleteDetails" CommandArgument='<%# Eval("Division_ID") %>' ToolTip="Delete" CssClass="" OnClientClick="return confirm('Are you sure you want to delete this record?');"><i class="fa fa-trash"></i></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
