<%@ Page Title="" Language="C#" MasterPageFile="~/Legal/MainMaster.master" AutoEventWireup="true" CodeFile="HearingDetails.aspx.cs" Inherits="Legal_HearingDetails" %>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="View More Detail" ShowHeader="False">
                                                    <ItemTemplate>
                                                        ...
                                                        <%--<asp:LinkButton ID="lnkEdit"  runat="server" CssClass="label label-default hidden" ToolTip='<%# Eval("Expense_ID").ToString() %>' OnClick="lnkEdit_Click" CausesValidation="False" Text="Edit"></asp:LinkButton>--%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                    ...
                                    <div class="col-md-6" id="DivHearingDate" runat="server">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date">
                                                        ...
                                                        <asp:TextBox ID="txtHearingDate" date-provide="datepicker" runat="server" placeholder="DD/MM/YYYY" class="form-control" ClientIDMode="Static" autocomplete="off" data-date-start-date="0d" ></asp:TextBox>
                                                    </div>
