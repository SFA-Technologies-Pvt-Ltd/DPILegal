...
public partial class Legal_DistricAdminDashBoard : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void BindCaseTypeCount(int OicId)
    {
        ...
        dsCasecount = objdb.ByProcedure("Sp_DistrictWiseCasesDashboard", new string[] { "OicId" }, new string[] { Convert.ToString(OicId) }, "dataset");
        string str = "";
    ...
    protected void CourtTypeCase(int OicId)
    {
        try
        {
            ...
            dsCase = objdb.ByProcedure("Sp_DistrictWiseCasesDashboard", new string[] { "OicId" }, new string[] { Convert.ToString(OicId) }, "dataset");
    ...
    protected void CourtTypeCase1(int OicId)
    {
        try
        {
            int CaseCount1 = 0;
            DataSet dsCase = new DataSet();
            dsCase = objdb.ByDataSet("Select CourtName as Court,COUNT(distinct UniqueNo) OrderBydirectCourtWiseCount from tblLegalCaseRegistration where CaseDisposalType_Id='2' and District_ID=" + OicId + " and Isactive=1  group by CourtName");
...
"COUNT(distinct UniqueNo) CaseSubjectWiseCount from tblLegalCaseRegistration a where District_ID=" + OicId + "" +
"group by a.CaseSubject_Id");
    ...
    protected void BIndWACaseCount(int OicId)
    {
        try
        {
            ds = objdb.ByProcedure("Sp_DistrictWiseCasesDashboard", new string[] { "OicId" }, new string[] { Convert.ToString(OicId) }, "dataset");
