                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdSub_Subect" runat="server" CssClass="datatable table table-bordered table-hover" AutoGenerateColumns="false" OnPageIndexChanging="grdSub_Subect_PageIndexChanging" OnRowCommand="grdSub_Subect_RowCommand" DataKeyNames="CaseSubSubj_Id" EmptyDataText="NO RECORD FOUND">
                                            <Columns>
