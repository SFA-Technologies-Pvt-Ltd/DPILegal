...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
            ...
            <div class="modal-dialog" style="width: 340px; display: table-cell; vertical-align: middle;">
                <div class="modal-content" style="width: inherit; height: inherit; margin: 0 auto;">
                    <div class="modal-header" style="background-color: #D9D9D9;">
                        <span class="modal-title" style="float: left" id="myModallbl">View Document</span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="GrdViewDoc" runat="server" AutoGenerateColumns="false" CssClass="table  table-bordered">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="View">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="hyperView" runat="server" Target="_blank" NavigateUrl='<%# Eval("Doc_Path") %>'></asp:HyperLink>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
    ...
    <asp:UpdatePanel ID="panel01" runat="server">
        <ContentTemplate>--%>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <fieldset id="Field_ExistRecord" runat="server" visible="false">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <asp:GridView ID="GrdExistRecord" runat="server" CssClass=" table table-bordered" OnRowCommand="GrdExistRecord_RowCommand" AutoGenerateColumns="false" DataKeyNames="UniqueNo">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="S.No." HeaderStyle-BackColor="#cc380b">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblSrno" runat="server" Text='<%# Container.DataItemIndex +1 %>'></asp:Label>
                                ...
                                <fieldset id="Field_NewRecord" runat="server" visible="false">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <asp:GridView ID="GrdNewRecord" runat="server" CssClass=" table table-bordered" AutoGenerateColumns="false">
                                                    <Columns>
                                ...
                                <div class="row">
                                    <div class="col-md-1">
                                        <asp:Button ID="btnSave" runat="server" CssClass="btn btn-primary btn-block" Visible="false" Text="Save" OnClick="btnSave_Click" OnClientClick="return ValidatePage();" />
                                    </div>
                                </div>
                            </div>
                        </div>
