<%@ Page Title="" Language="C#" MasterPageFile="~/Legal/MainMaster.master" AutoEventWireup="true" CodeFile="JDLegalDashBoard.aspx.cs" Inherits="Legal_JDLegalDashBoard" %>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header" style="text-align: center;">
                        <span style="font-size: 18px; color: #e5e5e5">JD DPI Legal Dashboard - </span><span style="font-size: 18px; color: #e5e5e5" runat="server" id="divCardHeader"></span>
                    </div>
