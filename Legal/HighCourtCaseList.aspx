<%@ Page Title="" Language="C#" MasterPageFile="~/Legal/MainMaster.master" AutoEventWireup="true" CodeFile="Report.aspx.cs" Inherits="Legal_HighCourtCaseList" %>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <%--<asp:Repeater ID="rptResponder" runat="server">
                                            <HeaderTemplate>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <%--<asp:Repeater ID="RptCaseDoc" runat="server">
                                            <HeaderTemplate>
                                                <table class="table table-bordered">
                                                    <tr>
                                                        <td>S.No.</td>
