<%@ Page Title="" Language="C#" MasterPageFile="~/Legal/MainMaster.master" AutoEventWireup="true" CodeFile="OICWiseCaseDtl.aspx.cs" Inherits="Legal_OICWiseCaseDtl" %>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlOicName" runat="server" CssClass="form-control">
                                            <asp:ListItem>Select</asp:ListItem>
                                            <asp:ListItem>Srikant Parte</asp:ListItem>
                                            <asp:ListItem>Mohan Parte</asp:ListItem>
                                            <asp:ListItem>Ajay Mishra</asp:ListItem>
                                            <asp:ListItem>Varun Diwvedi</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                 <div class="col-md-3">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdOICWiseCasedtl" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false" OnRowCommand="grdOICWiseCasedtl_RowCommand" DataKeyNames="ID" >
                                            <Columns>
