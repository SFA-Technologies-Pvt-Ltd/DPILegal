...
public partial class BulkUploadData : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            LoadExcel("ExcelsheetNew_Close.xls");  //"phe-cc-2000-2023_New_17_Jan_2023.xls"
        }
    }
    ...
    protected void btnbulkSave_Click(object sender, EventArgs e)
    {
        ...
        objbulk.DestinationTableName = "tbl_OrderByDirectionPendingDPICase";// "tbl_OldCaseDetail";
