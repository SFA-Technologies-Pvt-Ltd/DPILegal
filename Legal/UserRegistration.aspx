                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdUserDetails" runat="server" CssClass="datatable table table-bordered table-hover text-center" AutoGenerateColumns="false" OnRowCommand="grdUserDetails_RowCommand">
                                            <Columns>
                                                <asp:TemplateField HeaderText="S.No.<br />सरल क्र.">
                                                 ...
                                                 <asp:TemplateField HeaderText="Active Status <br />सक्रिय स्थिति">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Office Type<br />कार्यालय का प्रकार">
                                                    <ItemTemplate>
